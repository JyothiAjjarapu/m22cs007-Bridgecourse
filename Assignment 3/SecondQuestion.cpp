//Minimum weight can be calculated by using the Kruskal's minimum spanning tree.
using namespace std;
#include<vector>
#include<iostream>
#include<algorithm>
class Mz{
    //parent array for disjoin sets datastructure.
    int* mnodes;
    //rank array for storing the ranks for the verticies visited.
    int* count;
